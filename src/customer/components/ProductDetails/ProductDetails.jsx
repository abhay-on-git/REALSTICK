     ...
     <div className="lg:pt-6">
      ...
      <div className="mx-auto max-w-2xl px-4 pb-16 pt-10 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pb-24 lg:pt-16">
        ...
        <div className="mt-4 lg:row-span-3 lg:mt-0">
          ...
          <p className="text-3xl tracking-tight text-gray-900 mr-3">{product.price}</p>
               <p className='line-through text-xl opacity-70'>$999</p>
               <p class="sm:px-3 sm:py-2 px-2 py-1 text-sm sm:text-xs lg:text-[1vmax] font-bold tracking-wide text-white uppercase bg-zinc-900 rounded-full">76%</p>
              </div>
